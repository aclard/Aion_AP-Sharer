...
class SysTrayIcon(object):
    ...
    def __init__(self,
        ...
        win32gui.Shell_NotifyIcon(win32gui.NIM_MODIFY, \
                        ...
                        hicon, "Balloon tooltip","Application has been closed to tray",200,"AP Sharer"))
    ...
    def destroy(self, hwnd, msg, wparam, lparam):
        if self.menu_action == self.QUIT: self.on_quit(self)
        nid = (self.hwnd, 0)
    ...
    def execute_menu_option(self, id):
        ...
        if menu_action == self.QUIT:
            ...
            menu_action(self)
        '''
        self.menu_action = self.menu_actions_by_id[id]
        win32gui.DestroyWindow(self.hwnd)
